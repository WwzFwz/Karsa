...
import { DraftPanel } from '../../components/voice/DraftPanel'
...
export function WorkspacePage() {
  ...
  const { doc, suggestion, tree } = useDocument()
  const { focusId, panelHidden, togglePanel, focusMode, toggleFocusMode, nodeOverrides, clearOverrides } = useView()
