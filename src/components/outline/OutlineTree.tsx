...
import { KIND_LABEL, RELATION_LABEL, STATE_LABEL } from '../../core/vocabulary'
...
export function OutlineTree({ compact = false }: { compact?: boolean }) {
  ...
  const { focusId, setFocus, collapsed, toggleCollapse, editingId, setEditingId } = useView()
  const { draftTargets } = useAssistant()
